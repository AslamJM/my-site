...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center md:flex-row">
      <div className="w-full md:w-1/2">
        ...
        <p className="text-xl 2xl:text-2xl">
          ...
          unde maxime accusantium culpa voluptatem repellat libero et molestiae
          debitis enim ea at voluptas excepturi.
        </p>
        <div className="mt-6">
